...
const products_array = [
  ...
  ["Een stille piano biedt je een echte akoestische piano-ervaring, waarbij een hoofdtelefoonfunctie je in staat stelt om in stilte te blijven oefenen, zonder anderen te storen.", 10.991, "fotos/foto2.png", "Yamaha C2X SH3 PE Black polished", true],
  ...
  [" Bij Wittmayer werkten in de topjaren 50 arbeidskrachten die samen jaarlijks ca. 400 instrumenten vervaardigden. Hoewel van ‘seriebouw’ werd gesproken, betrof het bouwen van de instrumenten voornamelijk handwerk.", 42.0099, "fotos/foto4.png", "Bösendorfer: Kurt Wittmayer klavecimbel", true],
  ...
  ["De 130 is al negentig jaar onze meest succesvolle rechtschapen. Zowel in muziekacademies als universiteiten vervangt het de vleugel. Het is mechanisch superieur aan in massa geproduceerde studiovleugels en heeft een duidelijk voller geluid.", 24.559, "fotos/foto9.png", " Steingraeber 130 T: A Professional Piano for the Pros", true],
  ...
  [" De Steinway D-274 is sinds 1884 onveranderd in de architectuur. Lang Lang, Daniel Barenboim en Christoph Eschenbach zijn slechts drie van de meer dan 2.500 Steinway-artiesten over de hele wereld die de Steinway Model D hun eerste keuze noemen. (De C-227 biedt een kleinere concertvleugelversie.)", 13.100, "fotos/foto12.png", " Steinway D-274", true],
  ...
  ["De Yamaha U1 TA3 combineert de geweldige akoestische prestaties van de Yamaha U1 met de rijke opties van Yamaha TransAcoustic 3. De Yamaha U1 is met uitstekende muzikale prestaties een blijvende favoriet onder veeleisende pianisten, waaraan veel andere rechtopstaande piano's worden gemeten. ", 21.195, "fotos/foto15.png", "Yamaha U1 C-Graded – Akoestische piano", true],
  ["Yamaha staat wereldwijd bekend om zijn betrouwbare kwaliteit en compromisloze vakmanschap. Met zijn prachtige heldere toon, volle baskant en sprankelende diskant biedt de Yamaha C3 een uitzonderlijke speelervaring die elke noot tot leven brengt met een ongekend niveau van diepte en emotie.", 14.190, "fotos/foto16.png", " Yamaha C3 – Akoestische vleugel", true],
  ...
  ["Qua design kunnen we de wortels terugvoeren naar 1905. We denken niet aan onze kleinste vleugel als een 'baby grand', simpelweg omdat het veel 'Best in its Class'-awards heeft ontvangen die het geluid prijzen als veel groter dan het instrument eruit ziet.", 14.1, "fotos/foto20.png", "Steingraeber A-170: The Salon Grand Piano", true],
  ["Bechstein C-234 semi-concertvleugel: indrukwekkende kracht, gekleurd en transparant geluid, prachtige touch. Met de hand gemaakt in Duitsland! ", 11.419, "fotos/foto21.png", "C. Bechstein C-234 semi-concert grand piano", true],
  ["De middelgrote C. Bechstein A-192 salonvleugel is ideaal voor afwerkingen in nobele fineer of martelrie die het een lust voor het oog maken. Aarzel niet om uw dealer om fineermonsters en speciale afwerkingen te vragen.",31.99, "fotos/foto22.png", "C. Bechstein A-192", true],
